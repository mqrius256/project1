...
export default function Form1() {
  ...
  <div  className="  IPAD:h-[1402px]   IPAD:flex IPAD:flex-col  bg-red-50 w-full h-[910px] grid grid-cols-2 ">
   ...
   <Image
    ...
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc euismod elit<br/> 
    sapien, eu tempor diam rhoncus et. 
    </div>


      <Link href="https://www.ivfuture.ro/academy.html"><button className=' IPAD:ml-[24px] text-white  rounded-[8px] ml-[150px] mt-[48px] flex  py-[16px] px-[48px] justify-center items-center gap-[10px] bg-orange-600  shadow-custom-shadow'>Enroll Now!  
    ...
    <div className='  absolute w-[424px] h-[541px] bg-orange-200 top-[24px] right-[24px] rounded-[24px]'>
   ...
   <div className='  bg-red-100 w-[40px] h-[40px] flex-shrink-0 rounded-[52px]'>
